    ...
    <table class="feedtable" style="margin:10px auto;">
        ...
        <tr>
            <td rowspan="3" style="text-align: center;">
                <img id="norobotpic" src="/feedback/getcapt/"
                     width="160" height="80"
                     alt="Подтвердите, что вы не робот" />
            </td>
            <td colspan="3">
                {if $error=='fcapt'}
                <span class="feedhighlight">Вы ошиблись при вводе.</span>&nbsp;
                {/if}
                Пожалуйста, введите символы изображенные на картинке слева.
                Регистр значения не имеет.
                <br />
                <a id="captchahelp" title="Нажать для перезагрузки картинки"
                   href="#"
                   style="text-decoration: none; border-bottom: 1px dotted #009FD4">Другую картинку?</a>
            </td>
        </tr>
        <tr>
            <td style="width:20%">Код с картинки</td>
            <td>
                <input type="text" id="fcapt" name="fcapt"
                       autocomplete="off"
                       class="feedinput"
        ...
        <tr>
            <td colspan="3" style="text-align:center; padding: 5px">
                ...
                <input type="submit" value="Отправить" class="feedinput"
