...
class MCandidatePoints extends Model {
    ...
    private $_types_markers = array(
        ...
        3 => array('церковь', 'храм', 'монастырь', 'мечеть', 'синагога', 'собор', 'часовня',), //церкви
        ...
        9 => array('гостиница', 'отель', 'хостел', 'санаторий', 'пансионат', 'база отдыха', 'дом отдыха',), //гостиницы
    );
