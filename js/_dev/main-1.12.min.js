...
this.href.split("#")[1].split("_")[1];if(a!="all"){$("#whatseelist tr").hide();$("#whatseelist tr.obj_type_"+a).show()}else $("#whatseelist tr").show();return false});$("a.typefilterlink0").live("click",function(){var a=this.href.split("#")[1].split("_")[1];if(a!="all"){$("#whatservlist tr").hide();$("#whatservlist tr.obj_type_"+a).show()}else $("#whatservlist tr").show();return false});$(".blog_entry_edit").live("click",function(){var a=this.id.split("_");showWindByURL(b+"ajax/blog/editform/",{brid:a[2]});
$("#eblog_text").live("mouseover",function(){$("#eblog_text").die("mouseover");$("#eblog_text").ckeditor(function(){},{customConfig:"../../../../config/config.cke.js"});$("#eblog_date").datepicker({dateFormat:"dd.mm.yy"})});$("#eblog_date").live("click",function(){$(this).datepicker({dateFormat:"dd.mm.yy"})});return false});$("#blog_entry_add").live("click",function(){showWindByURL(b+"ajax/blog/addform/",null);$("#eblog_text").live("mouseover",function(){$("#eblog_text").die("mouseover");$("#eblog_text").ckeditor(function(){},
{customConfig:"../../../../config/config.cke.js"});$("#eblog_date").datepicker({dateFormat:"dd.mm.yy"})});$("#eblog_date").live("click",function(){$(this).datepicker({dateFormat:"dd.mm.yy"})});return false});$(".blog_entry_delete").live("click",function(){var a=this.id.split("_");confirm('\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u043e \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0437\u0430\u043f\u0438\u0441\u044c "'+$(this).parent("h2").children("a").text()+'"?')&&
$.post(b+"ajax/blog/delentry/?bid="+a[2],{brid:a[2]},function(g){if(g)document.location="../../blog/"});return false})});function showWindByURL(b,a){$(document).css("cursor","progress");$.get(b,a,function(g){$.modal(g,{overlayClose:true,opacity:80,width:600,height:200,overlayCss:{backgroundColor:"#ddd"}})});$(document).css("cursor","default")}
