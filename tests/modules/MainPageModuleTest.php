...
class MainPageModuleTest extends AbstractModulesTestingDependencies
{
    /**
     * @param string $key
    ...
    public function testApplicableMethod(string $key, bool $isApplicable): void
    {
        ...
        $module = new MainPageModule($db, $templateEngine, $webUser, $globalConfig);
    ...
    {
        return [
            'подходящий запрос' => ['index.html', true],
